...
class TransactionController extends Controller
{
    ...
    public function listOnGoing()
    {
        try {
            ...
            return response()->json(['error' => 'Cannot Get ListOnGoing'], 401);
        }
    }
    ...
    public function method()
    {
        try {
            ...
            return response()->json(['error' => 'Cannot Get Method'], 401);
        }
    }
    ...
    public function create(Request $request)
    {
        ...
        if (!$storage || $storage[0]->availability < $request->slot) {
            ...
            try {
                ...
                $unit_available = DB::select(DB::raw("SELECT u.unit_id,u.unit_code FROM unit u WHERE 
                NOT EXISTS (SELECT * FROM transaction t JOIN transaction_item ti WHERE u.unit_id=ti.unit_id AND 
                t.transaction_id=ti.transaction_id AND (start_rent <= '" . $request->end_rent . "' and end_rent >= '" . $request->start_rent . "'))
                ...
                return response()->json(['error' => 'Cannot Add Transaction'], 401);
            }
        }
    }
    ...
    public function detail($transaction_id)
    {
        try {
            ...
            return response()->json(['error' => 'Cannot Get Detail Transaction'], 401);
        }
    }
}
