                ...
                <div class="col-lg-5 col-md-7">
                    <div class="card bg-secondary border-0 mb-0">
                        <div class="card-header bg-transparent pb-3">
                            <div class="text-muted text-center mt-2 mb-1">Write your email to change the password</div>
                        </div>
                        <div class="card-body px-lg-5 py-lg-5">
                            <form role="form" action="/postemailforgotpassword" method="POST">
                                @csrf
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success my-4 btn-block">Send Email</button>
                                </div>
                            </form>
                        </div>
                    </div>
